...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">Stok Items Consumable ASI-2</h1>
      </div>
      <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card" id="CardHead">
                    <div class="card-header" style="background-color:  rgb(245, 238, 163)">
                        <h3 class="card-title">
                        <i class="fas fa-store"></i>
                            List Stok Item Consumable
                        </h3>
                      <div class="card-tools">
                        <button class="btn btn-warning btn-sm" id="btn_add"><i class="fa fa-plus"></i> Add</button>
                        <a href="{{route("stokconsum2.export")}}" class="btn btn-success btn-sm"><i class="fa 	fas fa-file-excel"></i> Export Excel</a>
                      </div>
                    </div>
        ...
        <div class="modal-body">
            <div class="form-group row">
                ...
                <div class="col-sm-9 mb-1">
                    ...
                    <select style="width: 100%;" id="item_id" class="form-control select2" class="text-center" required>
                        <option value="" selected>- pilih -</option>
                        @foreach ($str_barangs as $barang)
                            <option style="text-align: center" value="{{ $barang->id }}">{{ $barang->name }} / {{ $barang->category}}</option>
                        @endforeach
                    </select>
                </div>
