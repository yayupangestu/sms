...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">Stok Items RTK ASI-2</h1>
      </div>
      <div class="col-sm-6">
                ...
                <div class="card" id="CardHead">
                    <div class="card-header" style="background-color:  rgb(245, 238, 163)">
                      ...
                      <div class="card-tools">
                        ...
                        <a href="{{route("stokrtk2.export")}}" class="btn btn-success btn-sm"><i class="fa 	fas fa-file-excel"></i> Export Excel</a>
                      </div>
                    </div>
