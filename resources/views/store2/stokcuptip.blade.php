...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">Stok Items Cuptip ASI-2 </h1>
      </div>
      <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header" style="background-color:  rgb(245, 238, 163)">
                    ...
                    <i class="fas fa-store"></i>
                        List Stok Item Cuptip
                    </h3>
                  <div class="card-tools">
                    <button class="btn btn-warning btn-sm" id="btn_add"><i class="fa fa-plus"></i> Add</button>
                    <a href="{{route("stokcuptip2.export")}}" class="btn btn-success btn-sm"><i class="fa 	fas fa-file-excel"></i> Export Excel</a>
                  </div>
                </div>
                </div>
                </div>
