            ...
            <div class="card">
                <div class="card-header" style="background-color:  rgb(245, 238, 163)">
                  ...
                  <div class="card-tools">
                    ...
                    <a href="{{ route('stokti2.export')}}" class="btn btn-success btn-sm"><i class="fa fas fa-file-excel">Export Excel</i></a>
