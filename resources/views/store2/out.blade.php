...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">List Item Out Store Room ASI-2</h1>
                </div>
                <div class="col-sm-6">
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List Item Out ASI-2 </h3>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header"
                    style="background: linear-gradient(to bottom, #003366 32%, #3366cc 100%); color:white">
                    <h4 class="modal-title" id="title1"><b>Add Item Out ASI-2</b></h4>
                    <h4 class="modal-title" id="title2"><b>Edit Item Out ASI-2</b></h4>
    ...
    <script>
        ...
        $(document).on("click", "#btn_export", function () {
            ...
            if (startDate && endDate) {
                ...
                window.location.href = "{{ route('strout-2.export') }}?start_date=" + startDate + "&end_date=" + endDate + "&barang_id=" + barangId;
            } else {
                Toast.fire({
                    icon: 'warning',
        ...
        function validasi() {
            $("#alert").show();
            if (date_plan.value != '' && line_id.value != '' && item_id.value != '' && qty_out.value != '') {
                return true;
            } else {
        ...
        $(document).on("click", "#btn_delete_line", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: "{{route('strout-2.destroyline')}}",
