...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Scan IN Stamping B1 B2</h1>
      </div>
      <div class="col-sm-6">
      </div>
    </div>
    ...
    <div class="row justify-content-center">
        ...
        <script>
            ...
            function sendDataToServer(dataToSend) {
                $.ajax({
                    url: "{{ route('scaninstmpb12.store2') }}",
                    method: 'POST',
                    data: dataToSend,
                    success: function (response) {
                        Swal.fire({
                        ...
                        if (qrDataArray.length >= 8) {
                            ...
                            $.ajax({
                                ...
                                success: function(checkResponse) {
                                    ...
                                    $.ajax({
                                        url: '{{ route('check.partNoPlanningB12') }}',
                                        method: 'GET',
                                        data: {
