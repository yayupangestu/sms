...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Scan QR Suplai NUT RAK 1</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        if (firstCode === secondCode) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('scanraklimabelas.storeScanOutNut') }}",
                        method: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                    ...
                    if (firstCode === "9004A-17210") {
                        $.ajax({
                            url: "{{ route('scanraklimabelas.activateRelay') }}",
                            method: 'GET',
                            success: function(response) {
                                Swal.fire({
                                ...
                                setTimeout(function() {
                                    $.ajax({
                                        url: "{{ route('scanraklimabelas.deactivateRelay') }}",
                                        method: 'GET',
                                        success: function() {
                            ...
                            error: function(error) {
                    ...
                    } else if (firstCode === "9004A-17222") {
                                    $.ajax({
                                        url: "{{ route('scanraklimabelas.activateRelayDua') }}",
                                        method: 'GET',
                                        success: function (response) {
                                            Swal.fire({
                                            ...
                                            setTimeout(function () {
                                                $.ajax({
                                                    url: "{{ route('scanraklimabelas.deactivateRelayDua') }}",
                                                    method: 'GET',
                                                    success: function () {
                                ...
                                }else if (firstCode === "90041-74048") {
                                    $.ajax({
                                        url: "{{ route('scanraklimabelas.activateRelayTiga') }}",
                                        method: 'GET',
                                        success: function (response) {
                                            Swal.fire({
                                                title: 'Relay 2 Activated!',
                                            ...
                                            setTimeout(function () {
                                                $.ajax({
                                                    url: "{{ route('scanraklimabelas.deactivateRelayTiga') }}",
                                                    method: 'GET',
                                                    success: function () {
                                                        console.log("Relay 2 dimatikan otomatis setelah 5 detik");
                                                    },
                                ...
                                } else if (firstCode === "90174-74065") {
                                    $.ajax({
                                        url: "{{ route('scanraklimabelas.activateRelayEmpat') }}",
                                        method: 'GET',
                                        success: function (response) {
                                            Swal.fire({
                                                title: 'Relay 2 Activated!',
                                            ...
                                            setTimeout(function () {
                                                $.ajax({
                                                    url: "{{ route('scanraklimabelas.deactivateRelayEmpat') }}",
                                                    method: 'GET',
                                                    success: function () {
                                                        console.log("Relay 2 dimatikan otomatis setelah 5 detik");
                                                    },
                                ...
                                } else if (firstCode === "90174-10038") {
                                    $.ajax({
                                        url: "{{ route('scanraklimabelas.activateRelayLima') }}",
                                        method: 'GET',
                                        success: function (response) {
                                            Swal.fire({
                                            ...
                                            setTimeout(function () {
                                                $.ajax({
                                                    url: "{{ route('scanraklimabelas.deactivateRelayLima') }}",
                                                    method: 'GET',
                                                    success: function () {
                                                        console.log("Relay 2 dimatikan otomatis setelah 5 detik");
                                                    },
