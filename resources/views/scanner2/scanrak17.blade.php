...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Scan QR Code Nut RAK 17</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        if (firstCode === secondCode) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('scanraktujuhbelas.storeScanOutNut') }}",
                        method: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                    ...
                    if (firstCode === "90174-10038") {
                        $.ajax({
                            url: "{{ route('scanraktujuhbelas.activateRelay') }}",
                            method: 'GET',
                            success: function(response) {
                                Swal.fire({
                                ...
                                setTimeout(function() {
                                    $.ajax({
                                        url: "{{ route('scanraktujuhbelas.deactivateRelay') }}",
                                        method: 'GET',
                                        success: function() {
                            ...
                            error: function(error) {
                                Swal.fire({
                                    ...
                                    $.ajax({
                                        url: "{{ route('scanraktujuhbelas.activateRelayDua') }}",
                                        method: 'GET',
                                        success: function (response) {
                                            Swal.fire({
                                ...
                                } else if (firstCode === "9004A-17269") {
                                    $.ajax({
                                        url: "{{ route('scanraktujuhbelas.activateRelayTiga') }}",
                                        method: 'GET',
                                        success: function (response) {
                                            Swal.fire({
