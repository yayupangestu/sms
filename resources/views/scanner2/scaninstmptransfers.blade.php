...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Scan IN Stamping 3000T</h1>
      </div>
      <div class="col-sm-6">
      </div>
    </div>
    ...
    <div class="row justify-content-center">
        ...
        <script>
            ...
            function onScanSuccess(qrCodeMessage) {
                if (!scannedOnce) {
                    ...
                    if (qrDataArray.length >= 8) {
                        ...
                        $.ajax({
                            url: '{{ route("getTransfers.qtyTransit") }}',
                            method: 'GET',
                            data: {
                                _token: '{{ csrf_token() }}',
            ...
            function sendDataToServer(dataToSend) {
                $.ajax({
                    url: "{{ route('scaninstmptransfers.store2') }}",
                    method: 'POST',
                    data: dataToSend,
                    success: function (response) {
                        Swal.fire({
...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Scan IN Stamping TRANSFERS</h1>
                </div>
                <div class="col-sm-6">
                </div>
            </div>
                        ...
                        if (qrDataArray.length >= 8) {
                            ...
                            $.ajax({
                                ...
                                success: function(checkResponse) {
                                    ...
                                    $.ajax({
                                        url: '{{ route('check.partNoPlanningTrf') }}',
                                        method: 'GET',
                                        data: {
