                ...
                @else
                    ...
                    <li class="nav-item {{ Request::is('strout', 'strin', 'exportall') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ Request::is('strout', 'strin', 'exportall') ? 'active' : '' }}">
                            <i class="fas fas fas fa-handshake"></i>
                            <p>
                                TRANSAKSI
                                <i class="right fas fa-angle-left"></i>
                            </p>
                    ...
                    <li
                        ...
                        <a href="#"
                            class="nav-link {{ Request::is('strout2', 'strout3', 'strout4', 'strout5', 'strout6', 'strout7') ? 'active' : '' }}">
                            <i class="fas fas fa-folder-open"
                                style="font-size:20px; color:rgb(167, 192, 192);text-shadow:5px 4px 6px #000000;"></i>
                            <p style="font-family: 'Times New Roman', Times, serif; font-size:17px">
                                E-SPB Line Stamping
                                <i class="right fas far fa-circle"
                                    style="font-size:14px;color:rgb(255, 255, 255);text-shadow:6px 5px 7px #000000;"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item ml-3">
