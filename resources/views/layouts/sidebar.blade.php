        ...
        <nav class="mt-4">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-legacy nav-compact"
                ...
                @else
                    ...
                    <li
                        class="nav-item {{ Request::is('tabellistdies', 'tabelprev', 'lkhdies', 'scandies') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ Request::is('tabellistdies', 'tabelprev', 'lkhdies', 'scandies') ? 'active' : '' }}">
                            <i class="nav-icon ph-duotone ph-wrench"></i>
                            <p>
                                Dies MTC
                                <i class="right fas fa-angle-left"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item ml-3">
                                <a href="{{ route('scandies.index') }}"
                                    class="nav-link {{ Request::is('scandies') ? 'active' : '' }}">
                                    <i class="nav-icon ph-duotone ph-table"></i>
                                    <p>
                                        Scan Dies
                                    </p>
                    ...
                    <li class="nav-item {{ Request::is('strout-2', 'strin2') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ Request::is('strout-2', 'strin2') ? 'active' : '' }}">
                            <i class="nav-icon ph-duotone ph-factory"></i>
                            <p>
                                DTransaksi
                                <i class="right fas fa-angle-left"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item ml-3">
                                <a href="{{ route('strout-2.index') }}"
                                    class="nav-link {{ Request::is('strout-2', ) ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-dolly"
                                        style="font-size:20px;color:rgb(245, 238, 163);text-shadow:6px 5px 7px #000000;"></i>
                                    Item Out
                                    </p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item ml-3">
                                <a href="{{ route('strin2.index') }}"
                                    class="nav-link {{ Request::is('strin2', ) ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ Request::is('strout_2', 'strout_3') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ Request::is('strout_2', 'strout_3') ? 'active' : '' }}">
                            <i class="nav-icon ph-duotone ph-factory"></i>
                            <p>
                                E-SPB Stamping ASI-2
                                <i class="right fas fa-angle-left"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item ml-3">
                                <a href="{{ route('strout_2.index') }}"
                                    class="nav-link {{ Request::is('strout_2') ? 'active' : '' }}">
                                    <i class="nav-icon 	far fa-file-alt"
                                        style="font-size:20px;color:rgb(167, 192, 192);text-shadow:6px 5px 7px #000000;"></i>
                                    <p>
                                        E-SPB LINE C
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item ml-3">
                                <a href="{{ route('strout_3.index') }}"
                                    class="nav-link {{ Request::is('strout_3') ? 'active' : '' }}">
                                    <i class="nav-icon 	far fa-file-alt"
                                        style="font-size:20px;color:rgb(167, 192, 192);text-shadow:6px 5px 7px #000000;"></i>
                                    <p>
                                        E-SPB LINE A
