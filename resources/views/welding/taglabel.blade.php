...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">LIST PART NO WELDING</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <select id="line" class="form-control border-primary" required>
                                ...
                                <option value="RBT-1">ROBOT-1</option>
                                <option value="RBT-2">ROBOT-2</option>
                                <option value="RBT-3">ROBOT-3</option>
                                <option value="RBT-4">ROBOT-4</option>
                                <option value="RBT-5">ROBOT-5</option>
                                <option value="RBT-6">ROBOT-6</option>
                                <option value="RBT-7">ROBOT-7</option>
                                <option value="RBT-8">ROBOT-8</option>
                                <option value="RBT-9">ROBOT-9</option>
                                <option value="RBT-10">ROBOT-10</option>
                                <option value="RBT-11">ROBOT-11</option>
                                <option value="RBT-12">ROBOT-12</option>
                                <option value="RBT-13">ROBOT-13</option>
                                <option value="RBT-14">ROBOT-14</option>
                                <option value="RBT-15">ROBOT-15</option>
                                <option value="RBT-16">ROBOT-16</option>
                                <option value="RBT-17">ROBOT-17</option>
                                <option value="RBT-18">ROBOT-18</option>
                                <option value="RBT-19">ROBOT-19</option>
                                <option value="RBT-20">ROBOT-20</option>
                                <option value="RBT-21">ROBOT-21</option>
                                ...
                                <option value="SSW-13">SSW-13</option>
                                <option value="SSW-14">SSW-14</option>
                                <option value="SSW-15">SSW-15</option>
                                <option value="SSW-16">SSW-16</option>
                                <option value="SSW-17">SSW-17</option>
                                ...
                                <option value="PSW-5">PSW-5</option>
                                <option value="PSW-6">PSW-6</option>
                                <option value="PSW-7">PSW-7</option>
                                <option value="PSW-8">PSW-8</option>
                                <option value="PSW-9">PSW-9</option>
                                <option value="PSW-10">PSW-10</option>
                                 <option value="RBTCO-1">RBTCO-1</option>
                                <option value="RBTCO-2">RBTCO-2</option>
                                <option value="RBTCO-3">RBTCO-3</option>
                                <option value="RBTCO-4">RBTCO-4</option>
                                <option value="RBTCO-5">RBTCO-5</option>
                                <option value="RBTCO-6">RBTCO-6</option>
                            </select>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '#btn_generate_all', function(e) {
            ...
            $.ajax({
                url: "{{ route('taglabelwelding.generateMultipleQrCodes') }}",
                method: 'POST',
                xhrFields: {
                ...
                success: function(response) {
                    ...
                    link.download = 'LabelWelding_' + new Date().toISOString().slice(0, 10) + '.pdf';
        ...
        function list() {
            var table = $('#example1').DataTable({
                ...
                pageLength: 15,
                ajax: {
                    url: "{{ route('taglabelwelding.list') }}"
                },
                columns: [{
                        data: null,
                        sortable: false,
        ...
        $(document).on("click", ".btn_edit", function() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('taglabelwelding.getdatabypart') }}",
                data: {
                    job_no: jobNo
                },
        ...
        function listdetail(job_no) {
            $('#example2').DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: "{{ route('taglabelwelding.listdetail') }}",
                    type: "GET",
                    data: {
                        job_no: job_no
                    }
                ...
                columns: [{
                        ...
                        render: function(data, type, row) {
                            return `<input type="checkbox" class="dataCheckbox" value="${data}" data-sts="${row.sts}"
                             style="width= 10px; height= 10px; transform: scale(1.5); accent-color: #007bff;">`;
                        }
                    },
        ...
        $(document).on("click", ".Save", function() {
            ...
            if (validasi()) {
                $.ajax({
                    type: 'POST',
                    url: "{{ route('taglabelwelding.store') }}",
                    data: {
        ...
        $(document).on("click", "#btn_delete_line", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('taglabelwelding.destroyline') }}",
                        data: {
                            id: id,
                            _token: '{{ csrf_token() }}'
                        },
