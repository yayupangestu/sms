...
<body>
    @foreach($data as $item)
        <div class="container">
            <div class="box header">TAG LABEL</div>
            ...
            <table class="product-table">
                ...
                <tr>
                    <td style="font-size: 25px; font-weight:900">{{ $item['part_no'] }}</td>
                    <td style="font-size: 25px; font-weight:900">{{ $item['job_no'] }}</td>
                      {{-- <td>{{ $item['uniqNo'] }}</td> --}}
            ...
            <table style="width:100%; border:0; margin-top:5px;">
                <tr>
                  ...
                  <td style="width:50%; text-align:center; vertical-align:top;">
                    <!-- QR Code (diturunkan sedikit) -->
                    <img src="data:image/svg+xml;base64,{{ $item['qrcode'] }}"
            ...
            <!-- Printed info -->
            <div class="footer">
                Proses<strong>{{ $item['tanggal'] }} - {{ $item['uniqNo']}}</strong>
            </div>
