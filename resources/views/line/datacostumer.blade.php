                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead style="background-color: rgb(252, 252, 177)">
                        <tr>
                            <th width="50">No</th>
                            <th class="text-center">Name Costumer </th>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="title1">Add Data Costumer</h4>
          <h4 class="modal-title" id="title2">Edit Data Costumer</h4>
