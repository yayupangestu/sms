...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">Data FG Stamping</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header" style="background-color: rgb(255, 255, 202)">
                            ...
                            <div
                                ...
                                <form id="importForm" action="{{ route('datafg.importDp') }}" method="POST"
                                ...
                                <a href="{{route("datafg.export")}}" class="btn btn-success btn-sm"><i style="font-size: 20px" class="ph-fill ph-microsoft-excel-logo"></i> Export Excel</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                <thead style="background-color: rgb(252, 252, 177)">
                                    <tr>
                                        ...
                                        <th class="text-center">Part No (G5)</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="title1">Add Data datafg</h4>
                    <h4 class="modal-title" id="title2">Edit Data datafg</h4>
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <label class="col-sm-3 col-form-label">Name datafg:</label>
                        <div class="col-sm-9">
