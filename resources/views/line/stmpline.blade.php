...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">Data Line Stamping</h1>
      </div>
      <div class="col-sm-6">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="title1">Add Stamping Line</h4>
          <h4 class="modal-title" id="title2">Edit Stamping Line</h4>
        ...
        <div class="modal-body">
            <div class="form-group row">
                ...
                <label class="col-sm-3 col-form-label">Qty Machine</label>
                <div class="col-sm-9">
                    <input type="text" id="machine" class="form-control form-control-sm" required>
                </div>
