...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">Data Line Welding</h1>
      </div>
      <div class="col-sm-6">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content shadow-sm border-0 rounded-3">
            ...
            <div class="modal-body text-center p-3">
                ...
                <a href="{{ route('format.export') }}" class="btn btn-outline-success btn-sm w-100 mb-2">
                    <i class="fas fa-download me-1"></i> Download Format
                </a>
                
                <a href="{{ route('dataWelding.export') }}" class="btn btn-outline-primary btn-sm w-100 mb-3">
...
@push('scripts')
    ...
    <script>
        ...
        function importData() {
            ...
            $.ajax({
                url: "{{ route('welding.importDp') }}", // Replace with your route name
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
