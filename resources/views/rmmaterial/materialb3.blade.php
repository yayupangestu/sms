        ...
        <div class="col-12">
            <div class="card">
                <form action="{{ route('lkhb3.update') }}" method="POST">
                    @csrf
                    <div class="card-header" style="background-color: rgb(106, 106, 106)">
                    <h3 class="card-title">Plan Material </h3>
                            ...
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table id="example1" class="table  table-bordered table-striped">
                                        <thead class="table" style="background-color:rgb(106, 106, 106)">
