      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            ...
            <label class="col-sm-1 col-form-label">Qty Plan:</label>
            <div class="col-sm-2">
            ...
            <label class="col-sm-2 col-form-label">Date Delivery:</label>
            <div class="col-sm-3 mb-1">
              {{-- <input type="hidden" id="id" class="form-control" required> --}}
              <input type="date" id="date_delivery" class="form-control form-control-sm" required>
            </div>
            ...
            <div class="col-sm-10 mt-2">
              ...
              <button id="print_selected" class="btn btn-primary">Cetak yang Dipilih</button>
                  ...
                  <table id="example2" class="table table-hover centered-text">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center" width="50">Material NO</th> <!-- New Column Header -->
                        <th>Supplaier</th>
                        <th>Date Delivery</th>
                      </tr>
                    </thead>
...
@push('scripts')
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    $("#id").val('');
                    $("#doc_no").val(+year+"-"+month+day+"0"+result.jml);
                    // $("#doc_no").val(year + "/" + "0" + "/" + month + "/" + day);
                    $("#date_plan").val('');
                    $('#line_id').val('');
                    $('#item_id').val('');
                    $("#qty_return").val('');
                        ...
                        },
                        {
                            ...
                            render: function (data) {
                                return '<a href="#" id="btn_edit" title="Edit" data-id="'+data+'" class="btn btn-warning btn-sm">'+
                                        ...
                                        '</a>'+
                                        '<a href="#" id="btn_print" title="Print" data-id="'+data+'" class="btn btn-info btn-sm ml-1">'+
    ...
    render: function(data, type, row) {
        return `
            <input type="checkbox" class="checkbox-row" value="${data}">
        `;
    },
    orderable: false,
    searchable: false
