...
<section class="content">
  <div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header" style="background-color: rgb(167, 167, 167)">
                  ...
                  <div class="card-tools">
                    ...
                    <a href="{{route("supplierrmnut.export")}}" class="btn btn-success btn-sm"><i class="fa 	fas fa-file-excel"></i> Export Excel</a>
                </div>
                </div>
    ...
    <script>
        ...
        $(document).on("click", ".Update", function () {
            if(validasi()){
                $.ajax({
                    type: 'POST',
                    url: "{{route('supplierrmnut.update')}}",
                    data: {
                            id: id.value,
                            name_suplai: name_suplai.value,
                            alamat: alamat.value,
        ...
        $(document).on("click", "#btn_delete", function () {
            ...
            Swal.fire({
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{route('supplierrmnut.destroy')}}",
