<html>
 ...
 <body>
  <div class="container">
   ...
   <div class="details">
    <div>
     <p style="font-size: 13px"><strong>Penerima:</strong>{{ $createdby}} </p>
     <p style="font-size: 13px"><strong>Diterima:</strong> {{$created_at}}</p>
    </div>
    <div>
     <p style="font-size: 12px"><strong>Pengirim:</strong>{{$supplier}}</p>
     <p></p>
    </div>
   </div>
   ...
   <div style="size: 100px" class="info">
    <p style="font-size: 13px"><strong>Dimensi :</strong>T={{ $spec_t}} x P={{ $spec_w}} x L={{ $spec_l}}</p>
    <p style="font-size: 13px"><strong>Part No :</strong> {{ $part_no }} </p>
    <p style="font-size: 13px"><strong>Model :</strong> {{ $model }}</p>
   </div>
   <table class="product-table">
    ...
    <tr>
     {{-- <td>1</td> --}}
     <td style="text-align: center; font-size:10px">{{ $spec }}</td>
     <td style="text-align: center; font-size:12px">{{ $actual }}</td>
     <td style="text-align: center; font-size:12px">{{ $uniq_no }}</td>
     <td style="text-align: center; font-size:12px">{{ $kg_sheet}}</td>
     <td style="text-align: center; font-size:12px">{{ $no_rak }}</td>
    </tr>
   </table>
  </div>
