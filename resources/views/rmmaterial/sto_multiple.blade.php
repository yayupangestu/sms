...
<body>
    ...
    <div class="container">
        ...
        <div class="order-number">
           Label STO / {{ $item['created_at'] }}
        </div>
       
        <div class="details">
            <div>
                <p style="font-size: 13px"><strong>Pembuat:</strong> {{ $item['createdby'] }} </p>
                <p style="font-size: 13px"><strong>Dibuat:</strong> {{ $item['created_at'] }}</p>
            </div>
            <div>
                <p style="font-size: 12px"><strong>Line:</strong> {{ $item['line_id'] }}</p>
                <p></p>
            </div>
        </div>
        ...
        <div style="size: 100px" class="info">
            <p style="font-size: 13px"><strong>Dimensi :</strong> T={{ $item['spek_t'] }} x P={{ $item['spek_w'] }} x L={{ $item['spek_l'] }}</p>
            <p style="font-size: 13px"><strong>Part No :</strong> {{ $item['part_no'] }} </p>
            <p style="font-size: 13px"><strong>Model :</strong> {{ $item['model_id'] }}</p>
        </div>
        <table class="product-table">
            ...
            <tr>
                <td style="text-align: center; font-size:12px">{{ $item['spek'] }}</td>
