...
<body>
  ...
  >
    ...
    style="
      ...
      font-size: 32px;         /* 🔥 teks lebih besar */
      font-weight: bold;
      background: #1C2536;
      color: #fff;
      border: none;
      ...
      cursor: pointer;
      box-shadow: 0 6px 10px rgba(0,0,0,0.3); /* 🔥 shadow lebih tebal */
    "
  >
    NEXT ➜
  </button>
...
<script>
 (function(){
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const pages = [
      { title: 'KAP-1', visibleCycles: [1,2,3,4] },
      { title: 'KAP-1', visibleCycles: [5,6,7,8] }
    ];
            ...
            for (let cycle = 1; cycle <= 9; cycle++) {
                ...
                if (grouped[cycle]) {
                    grouped[cycle].forEach(data => {
                        ...
                        div.innerHTML = `
                            <strong style="font-size: 75%;">${data.uniqNo}</strong>
                          <span style="font-size: 75%" class="qty-box-white">
                            ${data.qty_order}
                            ${
                              strength > 1.0
