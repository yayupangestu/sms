...
@section('content')
    ...
    <style>
        .custom-dashboard {
            background: linear-gradient(to bottom right, #f6f6f6 0%, #6e6e6f 100%);
        ...
        <div class="container-fluid">
            <div style="background: linear-gradient(to bottom, #003366 25%, #000000 78%);"
                ...
                <div class="col-md-6" style="position: relative;">
                    ...
                    <strong>
                        <h3 style="color: white; display: inline;">Dashboard Informasi Stamping Blank</h3>
                    </strong>
                </div>
    ...
    <section class="custom-dashboard">
        <div class="container-fluid h-50">
            <div class="row">
                <div class="col-md-6">
                    <div class="container">
                        <div class="card info-box" style="cursor: zoom-in;" onclick="showIncomingMaterials('KOMATSU')">
                            ...
                            <div class="metric-card text-center mt-2">
                                <h4 class="text-white mb-1">KOMATSU</h4>
                            </div>
                            ...
                            <div class="status-badge text-center mb-2">
                                <span class="badge bg-info clickable-badge text-dark" data-bs-toggle="modal"
                                    data-bs-target="#statusModal" data-mesin="KOMATSU"
                        ...
                        <div class="card info-box" style="cursor: zoom-in;" onclick="showIncomingMaterials('FUKUI')">
                            <img src="dist/img/press-machine (7).png" class="brand-image img-fluid"
                                alt="press-machine (7) Image">
                            <div class="metric-card text-center mt-2">
                                <h4 class="text-white mb-1">FUKUI</h4>
                            </div>
                            <div class="progress-bar my-2">
                                <div class="available" style="width: 100%;"></div>
                            </div>
                            <div class="status-badge text-center mb-2">
                                <span class="badge bg-info clickable-badge text-dark" data-bs-toggle="modal"
                                    data-bs-target="#statusModal" data-mesin="FUKUI"
                                    style="font-size: 0.85rem; padding: 6px 12px; border-radius: 6px; cursor: pointer;">
                                    Status Mesin
                                </span>
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        <!-- Date Plan -->
                        <label for="date_plan" class="col-sm-2 col-form-label text-black">TANGGAL:</label>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-5 d-flex align-items-center gap-2">
                            ...
                            <div id="loading-spinner" class="ms-3 mt-1" style="display: none;">
                                <i class="fas fa-sync-alt fa-spin text-black fa-2x" style="opacity: 0.8;"></i>
                            </div>
                    ...
                    <hr class="my-3">
                    <div class="form-group row align-items-center">
                        <label for="page_selector" class="col-sm-2 col-form-label text-black">BIKIN LABEL:</label>
                        <div class="col-sm-2">
                            <select id="page_selector" class="form-control form-control-sm">
                                <option value="" selected disabled>- Pilih Line -</option>
                                <option value="kanbanstmpkomatsu">KOMATSU</option>
                                <option value="kanbanstmpfukui">FUKUI</option>
                            </select>
                        </div>
                        <div class="col-sm-2">
...
@push('scripts')
    ...
    <script>
        ...
        //         })
        //         .catch(error => {
        //             console.error("Gagal ambil data KOMATSU:", error);
        //         });
        // });
        ...
        //         })
        //         .catch(error => {
        //             console.error("Gagal ambil data FUKUI:", error);
        //         });
        // });
        ...
        const fetchAndDisplayData = () => {
                ...
                fetch(`{{ route('dashboardplanningblank.getIncomingMaterials') }}?mesin=${line}&date_plan=${selectedDate}`)
                    .then(response => response.json())
                    .then(data => {
        ...
        document.addEventListener("click", function(event) {
            if (event.target.classList.contains("remark-proses-btn")) {
                ...
                <select id="remarkOption" class="swal2-input">
                    ...
                    <option value="Troubel Mesin">Troubel Mesin</option>
                     ...
                     <option value="RM T/A LAGI">RM T/A</option>
            ...
            `,
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('dashboardplanningblank.updateRemark') }}',
                            method: 'POST',
                            data: {
                                part_no2: partNo2,
                                date_plan: datePlan,
