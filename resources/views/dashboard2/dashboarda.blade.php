        ...
        <div class="container-fluid">
            <div style="background: linear-gradient(to bottom, #003366 25%, #000000 78%);"
                ...
                <div class="col-md-6" style="position: relative;">
                    ...
                    <strong>
                        <h3 style="color: white; display: inline;">Dashboard Informasi Stamping A1 & A2</h3>
                    </strong>
                </div>
    ...
    <section class="custom-dashboard">
        <div class="container-fluid h-50">
            <div class="row">
                <div class="col-md-6">
                    <div class="container">
                        <div class="card info-box" style="cursor: zoom-in;" onclick="showIncomingMaterials('LINE A1')">
                            ...
                            <div class="metric-card text-center mt-2">
                                <h4 class="text-white mb-1">LINE A1</h4>
                            </div>
                            ...
                            <div class="status-badge text-center mb-2">
                                <span class="badge bg-info clickable-badge text-dark" data-bs-toggle="modal"
                                    data-bs-target="#statusModal" data-mesin="LINE A1"
                        ...
                        <div class="card info-box" style="cursor: zoom-in;" onclick="showIncomingMaterials('LINE A2')">
                            <img src="dist/img/press-machine (7).png" class="brand-image img-fluid"
                                alt="press-machine (7) Image">
                            <div class="metric-card text-center mt-2">
                                <h4 class="text-white mb-1">LINE A2</h4>
                            </div>
                            <div class="progress-bar my-2">
                                <div class="available" style="width: 100%;"></div>
                            </div>
                            <div class="status-badge text-center mb-2">
                                <span class="badge bg-info clickable-badge text-dark" data-bs-toggle="modal"
                                    data-bs-target="#statusModal" data-mesin="LINE A2"
                                    onclick="event.stopPropagation();"
                                    style="font-size: 0.85rem; padding: 6px 12px; border-radius: 6px; cursor: pointer;">
                                    Status Mesin
                                </span>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-2">
                            <select id="page_selector" class="form-control form-control-sm">
                                ...
                                <option value="kanbanstmpa1">Kanban STMP B1</option>
                                <option value="kanbanstmpa2">Kanban STMP B2</option>
                            </select>
                        </div>
                        <div class="col-sm-2">
                            ...
                            <div class="modal-content border-0 shadow-lg rounded-4">
                                ...
                                <div class="modal-body p-4 bg-light">
                                    ...
                                    <div class="mb-4 d-flex gap-2 flex-wrap">
                                        ...
                                        <button class="btn btn-outline-warning line-btn text-dark" data-line-id="LINE A2">
                                            <i class="bi bi-tools me-1"></i> LINE A2
                                        </button>
                                    </div>
        ...
        <div class="modal fade" id="exportExcelModal" tabindex="-1" aria-labelledby="exportExcelModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="{{ route('dashboardplanninga12.export') }}" method="GET">
                        <div class="modal-body">
                            <div class="mb-3">
...
@push('scripts')
    ...
    <script>
        ...
        //         const tbody = document.getElementById("lineA1Body");
        //         tbody.innerHTML = "";
        ...
        //         })
        //         .catch(error => {
        //             console.error("Gagal ambil data LINE A1:", error);
        //         });
        // });
        ...
        //     function renderTablePage(page) {
        //         const tbody = document.getElementById("lineA2Body");
        //         lineA2Body
        //         tbody.innerHTML = "";
        ...
        //         })
        //         .catch(error => {
        //             console.error("Gagal ambil data LINE A2:", error);
        //         });
        // });
        ...
        const fetchAndDisplayData = () => {
                ...
                fetch(`{{ route('dashboardplanninga12.getIncomingMaterials') }}?mesin=${line}&date_plan=${selectedDate}`)
                    .then(response => response.json())
                    .then(data => {
        ...
        function reloadMachineCondition() {
            ...
            $.ajax({
                url: "{{ route('dashboardplanninga12.getMachineCondition') }}",
                type: "GET",
                data: { date: date },
        ...
        function reloadDiesHistory() {
            const date = $("#date_plan").val();
            $.ajax({
                url: "{{ route('dashboardplanninga12.getDiesHistory') }}",
                type: "GET",
                data: { date: date },
                success: function(data) {
                    let html = "";
    ...
    if (event.target.classList.contains('approve-production-btn')) {
        ...
        $.ajax({
            url: '{{ route("dashboardplanninga12.getActualProduction", ":id") }}'.replace(':id', id),
            method: 'GET',
                        ...
                        if (actualQty < qtyPlan) {
                            Swal.fire({
                                ...
                                if (remarkResult.isConfirmed) {
                                    ...
                                    $.ajax({
                                        url: '{{ route('dashboardplanninga12.approveProduction') }}',
                                        method: 'POST',
                                        data: {
                                            id: id,
            ...
            if (event.target.classList.contains("cancel-proses-btn")) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('dashboardplanninga12.cancelProduction') }}',
                            method: 'POST',
                            data: {
                                part_no: partNo,
                                date_plan: datePlan,
        ...
        document.addEventListener("click", function(event) {
            ...
            `,
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('dashboardplanninga12.updateRemark') }}',
                            method: 'POST',
                            data: {
                                part_no2: partNo2,
                                date_plan: datePlan,
        ...
        function reloadMaintenanceHistory() {
            const date = $("#date_plan").val();
            $.ajax({
                url: "{{ route('dashboardplanninga12.getMaintenanceHistory') }}",
                type: "GET",
                data: { date: date },
                dataType: "json",
                success: function(data) {
