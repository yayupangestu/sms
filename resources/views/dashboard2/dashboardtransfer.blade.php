        ...
        <div class="container-fluid">
            <div style="background: linear-gradient(to bottom, #003366 25%, #000000 78%);"
                ...
                <div class="col-md-6" style="position: relative;">
                    ...
                    <strong>
                        <h3 style="color: white; display: inline;">Dashboard Informasi Stamping TRANSFERS</h3>
                    </strong>
                </div>
    ...
    <section class="custom-dashboard">
        <div class="container-fluid h-50">
            <div class="row">
                <div class="col-md-6">
                    <div class="container">
                        <div class="card info-box" style="cursor: zoom-in;" onclick="showIncomingMaterials('TRANSFERS')">
                            ...
                            <div class="metric-card text-center mt-2">
                                <h4 class="text-white mb-1">TRANSFERS</h4>
                            </div>
                            ...
                            <div class="status-badge text-center mb-2">
                                <span class="badge bg-info clickable-badge text-dark" data-bs-toggle="modal"
                                    data-bs-target="#statusModal" data-mesin="TRANSFERS"
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-2">
                            <select id="page_selector" class="form-control form-control-sm">
                                ...
                                <option value="kanbanstmptransfers">Kanban TRANSFERS</option>
                            </select>
                        </div>
                        <div class="col-sm-2">
...
@push('scripts')
    ...
    <script>
        ...
        const fetchAndDisplayData = () => {
                ...
                fetch(`{{ route('dashboardplanningatransfers.getIncomingMaterials') }}?mesin=${line}&date_plan=${selectedDate}`)
                    .then(response => response.json())
                    .then(data => {
        ...
        function reloadMachineCondition() {
            ...
            $.ajax({
                url: "{{ route('dashboardplanningatransfers.getMachineCondition') }}",
                type: "GET",
                data: { date: date },
        ...
        function reloadDiesHistory() {
            const date = $("#date_plan").val();
            $.ajax({
                url: "{{ route('dashboardplanningatransfers.getDiesHistory') }}",
                type: "GET",
                data: { date: date },
                success: function(data) {
                    let html = "";
    ...
    if (event.target.classList.contains('approve-production-btn')) {
        ...
        $.ajax({
            url: '{{ route("dashboardplanningatransfers.getActualProduction", ":id") }}'.replace(':id', id),
            method: 'GET',
                        ...
                        if (actualQty < qtyPlan) {
                            Swal.fire({
                                ...
                                if (remarkResult.isConfirmed) {
                                    ...
                                    $.ajax({
                                        url: '{{ route('dashboardplanningatransfers.approveProduction') }}',
                                        method: 'POST',
                                        data: {
                                            id: id,
            ...
            if (event.target.classList.contains("cancel-proses-btn")) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('dashboardplanningatransfers.cancelProduction') }}',
                            method: 'POST',
                            data: {
                                part_no: partNo,
                                date_plan: datePlan,
        ...
        document.addEventListener("click", function(event) {
            ...
            `,
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '{{ route('dashboardplanningatransfers.updateRemark') }}',
                            method: 'POST',
                            data: {
                                part_no2: partNo2,
                                date_plan: datePlan,
        ...
        function reloadMaintenanceHistory() {
            const date = $("#date_plan").val();
            $.ajax({
                url: "{{ route('dashboardplanningatransfers.getMaintenanceHistory') }}",
                type: "GET",
                data: { date: date },
                dataType: "json",
                success: function(data) {
