                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-2">
                            <select id="page_selector" class="form-control form-control-sm">
                                ...
                                <option value="kanbanstmpa1">Kanban STMP A1</option>
                                <option value="kanbanstmpa2">Kanban STMP A2</option>
                            </select>
                        </div>
                        <div class="col-sm-2">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    <div class="p-2 bg-gray text-white rounded-top shadow-sm mb-0 d-flex justify-content-center align-items-center">
                                        ...
                                        <h5 class="mb-0 fw-bold">LINE A1</h5>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="p-2 bg-gray text-white rounded-top shadow-sm mb-0 d-flex justify-content-center align-items-center">
                                        <i class="fa fa-cogs me-2"></i>
                                        <h5 class="mb-0 fw-bold">LINE A2</h5>
                                    </div>
                            ...
                            preConfirm: () => {
                                ...
                                if (!qty || isNaN(qty) || qty <= 0) {
                                    Swal.showValidationMessage(
                                        'Masukkan Qty Actual yang valid!');
                                    return false;
                                }
            ...
            if (event.target.classList.contains("remark-proses-btn")) {
                ...
                <select id="remarkOption" class="swal2-input">
                    ...
                    <option value="Jumsih">Jumsih</option>
                     <option value="Brcode TA">Barcode TA</option>
                     <option value="BLANK TCF">BLANK TCF </option>
                     <option value="PROSES 2X">PROSES 2X </option>
                     <option value="T.DIES&MESIN">T.DIES&MESIN </option>
