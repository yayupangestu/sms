                    ...
                    <div class="container">
                        <div class="card info-box" style="cursor: zoom-in;" onclick="showIncomingMaterials('TRANSFERS')">
                            ...
                            <div class="metric-card text-center mt-2">
                                <h4 class="text-white mb-1">3000 TON</h4>
                            </div>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    <div class="p-2 bg-gray text-white rounded-top shadow-sm mb-0 d-flex justify-content-center align-items-center">
                                        ...
                                        <h5 class="mb-0 fw-bold">LINE TRANSFERS</h5>
                                    </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function renderTablePage(page) {
                const tbody = document.getElementById("lineTransfersBody");
                tbody.innerHTML = "";
            ...
            fetch("{{ route('linetransfers.data') }}")
                ...
                .catch(error => {
                    console.error("Gagal ambil data LINE TRANSFERS:", error);
                });
        });
