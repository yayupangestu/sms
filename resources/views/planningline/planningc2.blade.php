...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">Planning Line C2</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="row">
          <div class="col-12">
              <div class="card">
                  ...
                  <h3 class="card-title"><b style="font-family: 'Times New Roman', Times, serif">List Planning Line C2</b></h3>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background-color: rgb(97, 255, 113)">
          <h4 class="modal-title" id="title1">Tambah Planning Line C2</h4>
          <h4 class="modal-title" id="title2">Edit Planning Line C2</h4>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 mb-1">
                    <select style="width: 100%;" id="product_id" class="form-control select2" required>
                        <option value="" selected>- pilih -</option>
                        @foreach ($tabel_c2_s as $tabelc2) ()
                            <option value="{{ $tabelc2->id }}">{{ $tabelc2->job_no }} - {{ $tabelc2->part_no }} / {{ $tabelc2->model_id }} / {{ $tabelc2->spec_id }}</option>
                        @endforeach
                    </select>
                </div>
    ...
    <script>
        ...
        function listdetail(){
            var table = $('#example2').DataTable({
                    ...
                    pageLength: 10,
                    ajax: {
                        url: "{{ route('planninglinec2.listdetail') }}",
                        data: {
        ...
        $(document).on("click", ".Save", function () {
            ...
            if(validasi()){
                $.ajax({
                    type: 'POST',
                    url: "{{route('planninglinec2.store')}}",
                    data: {
                        date_plan: date_plan.value,
                        line_id: line_id.value,
        ...
        $(document).on("click", ".Update", function () {
            if(validasi()){
                $.ajax({
                    type: 'POST',
                    url: "{{route('planninglinec2.update')}}",
                    data: {
                            id: id.value,
                            product_id: product_id.value,
                            qty_plan: qty_plan.value,
        ...
        function validasi(){
            $("#alert").show();
            if(date_plan.value != '' && line_id.value != '' && product_id.value != '' && qty_plan.value != ''){
                return true;
            }else{
        ...
        $(document).on("click", "#btn_delete_line", function () {
            ...
            Swal.fire({
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{route('planninglinec2.destroyline')}}",
        ...
        $(document).on("click", "#btn_delete", function () {
            ...
            Swal.fire({
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{route('planninglinec2.destroy')}}",
