...
<div class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="m-0">Laporan Harian Kerja LINE C2</h1>
        </div>
        <div class="col-sm-6">
...
<section class="content">
  <div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('lkhc2.update') }}" method="POST">
                    @csrf
                    <div class="card-header" style="background-color: rgb(245, 241, 168)">
                    <h3 class="card-title">Laporan Harian Kerja c2</h3>
