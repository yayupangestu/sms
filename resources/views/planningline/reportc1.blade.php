...
<div class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="m-0" style="font-family: 'Times New Roman', Times, serif">Report Laporan Harian Kerja LINE C1</h1>
        </div>
        <div class="col-sm-6">
                ...
                <div class="card shadow">
                    <div class="card-header bg-secondary text-white">
                        <h3 class="card-title" style="font-family: 'Times New Roman', Times, serif">
                            <i class="fa fa-file-alt"></i> Laporan Harian Kerja LINE C1
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
