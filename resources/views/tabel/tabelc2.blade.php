...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">Data List Part Produksi c1</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group row">
                ...
                <div class="col-sm-9 mb-1">
                    <select style="width: 100%;" id="shop_id" class="form-control select2" required>
                        <option value="" selected>- pilih -</option>
                        @foreach ($data_costumers as $costumer)
...
@push('scripts')
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(result) {
                    if(result.success){
                        ...
                        $('#shop_id').val(result.shop_id).trigger('change');
                    }else{
                        SweetAlert.fire({
        ...
        function validasi(){
            $("#alert").show();
            if(job_no.value != '' && part_no.value != '' && model_id.value != '' && type_id.value !='' && shop_id.value !='' && spec_id.value !=''){
                return true;
            }else{
