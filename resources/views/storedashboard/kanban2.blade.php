...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Dashboard Kanban User</h1>
      </div>
...
<div class="col-md-3 col-sm-6 col-12 mb-4">
  <div class="info-box bg-proses-spb-send">
    ...
    <div class="info-box-content">
      <strong><span class="info-box-text">WELDING ROBOT-1</span></strong>
      <span class="info-box-number" style="font-size: 16px;">{{ $data->doc_no }}</span>
      <div class="progress">
        <div class="progress-bar" style="width: 100%"></div>
      </div>
...
<script>
    ...
    $(document).ready(function() {
      ...
      $.ajax({
        url: 'http://127.0.0.1:8000/kanban/get-new-data',
        method: 'GET',
        success: function(response) {
          ...
          if (Array.isArray(status1) && Array.isArray(status2)) {
            ...
            updateInfoBox14('#info-box-status1 .row', status27, 'ORDER', 'bg-proses-spb-order-produksi2');
            updateInfoBox14('#info-box-status2 .row', status28, 'SEND', 'bg-proses-spb-send', true);
            updateInfoBox15('#info-box-status1 .row', status29, 'ORDER', 'bg-proses-spb-order-produksi2');
            updateInfoBox15('#info-box-status2 .row', status30, 'SEND', 'bg-proses-spb-send', true);
            updateInfoBox16('#info-box-status1 .row', status31, 'ORDER', 'bg-proses-spb-order-produksi2');
            ...
            container.append(`
                <div class="col-md-3 col-sm-6 col-12 mb-4">
                    <div class="info-box ${boxClass}">
                        ...
                        <div class="info-box-content">
                            <strong><span class="info-box-text">WELDING FUELd TANK</span></strong>
                            <span class="info-box-number" style="font-size: 16px;">${item.doc_no}</span>
                            <div class="progress">
                                <div class="progress-bar" style="width: 100%"></div>
                            </div>
