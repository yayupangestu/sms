      ...
      <div class="row">
          <div class="col-12">
              <div class="card">
                  ...
                  <h3 class="card-title"><b style="font-family: 'Times New Roman', Times, serif">List DN TCF-2</b></h3>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="background-color: rgb(97, 255, 113)">
          <h4 class="modal-title" id="title1">Tambah DN TCF-2</h4>
          <h4 class="modal-title" id="title2">Edit DN TCF-2</h4>
