...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">List Prepare Deliver KAP-1</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List List Prepare Deliver KAP-1</h3>
...
@push('scripts')
    ...
    <script>
        ...
        //                     return;
        //                 }
        //                 let uniqNoToCheck = parts[4]; // Contoh: "W630102501"
        //                 console.log("UniqNo ke-2:", uniqNoToCheck);

        //                 // 🔎 Cek status_prepare ke server
        //                 $.ajax({
        //                     url: "{{ route('check.label.welding') }}",
        //                     type: "GET",
        //                     data: {
        //                         no_label_welding: uniqNoToCheck
        //                     },
        //                     success: function(res) {
