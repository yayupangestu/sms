...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">Stok Items ATK ASI-1</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card" id="CardHead">
                        <div class="card-header" style="background-color:  rgb(126, 144, 144)">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="{{route("stokatk.export")}}" class="btn btn-success btn-sm"><i
