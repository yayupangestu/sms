...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">E-Surat Permintaan Barang LINE Tool Making ASSY</h1>
      </div>
      <div class="col-sm-6">
      </div>
    </div>
  ...
  <div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card" id="CardHead">
                <div class="card-header">
                    ...
                    E-Surat Permintaan Barang Tool Making ASSY(SPB) 
                ...
                <div class="card-body">
                    <div class="date-filter">
                        ...
                        <button class="btn btn-success btn-sm" id="btn_export"><i class="fa fa-file-excel"></i> Export Excel</button>
                    </div>
                    <br>
   ...
   <div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('strout20.update') }}" method="POST">
                    @csrf
                    <div class="CardHead">
                        <div class="card-header">
                            <h3 class="card-title">
               ...
               <div class="col-sm-7"></div>
                ...
                <div class="col-sm-7 mb-1">
                    <select style="width: 100%;" id="item_id" class="select2" required>
                        <option value="" selected>- pilih -</option>
                        @php
                        $sorterdBarangs = $str_barangs->sortBy('name');
                        @endphp
...
@push('scripts')
    ...
    <script>
            ...
            $(document).ready(function() {
                var getActualUrl = '{{ route('strout20.getActual') }}'; // Menghasilkan URL route
            ...
            function getDoc(){
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{route('strout20.getdoc')}}",
                    success: function(result) {
                        $("#id").val('');
                        $("#doc_no").val("SPB/ASI/TM/ASSY"+year+month+"/"+result.jml);
                        $("#date_plan").val('');
                        $('#line_id').val('');
                        $('#item_id').val('');
                        $("#qty_return").val('');
          ...
          // Script untuk menangani klik tombol detail dan memuat modal
            $(document).on("click", ".btn-details", function () {
                var doc_no = $(this).data('doc_no'); // Ambil doc_no dari tombol yang diklik
                 ...
                 $.ajax({
                    type: 'GET',
                    url: "{{ route('strout20.listdetail3') }}", // Route yang mengarah ke listdetail3
                        data: {
                            doc_no: doc_no
                        },
                        success: function(result) {
                ...
                document.getElementById("saveChecked").addEventListener("click", function() {
                    ...
                    if (checkedItems.length > 0) {
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('strout20.saveChecked') }}",  // Sesuaikan URL
                            data: {
                                items: checkedItems,
            ...
            $(document).on("click", "#btn_search", function () {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{route('strout20.listdetail2')}}",
                    data: {
                            doc_no: doc_no,
                        },
                        success: function(result) {
            ...
            function delete_draft(){
                    $.ajax({
                        type: 'POST',
                        url: "{{route('strout20.delete_draft')}}",
                        data: {
                            doc_no: doc_no.value,
                            _token: '{{csrf_token()}}'
                            },
            ...
            const Toast = Swal.mixin({
                ...
                container: 'swal2-toast-container'
                    ...
                    window.location.href = "{{ route('strout20.export') }}?start_date=" + startDate + "&end_date=" + endDate;
                    } else {
                    Toast.fire({
                    icon: 'warning',
            ...
            $(document).on("click", "#btn_delete_line", function () {
                ...
                Swal.fire({
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{route('strout20.destroyline')}}",
