...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">E-Surat Permintaan Barang LINE Welding PSW Robot-1</h1>
                </div>
                <div class="col-sm-6">
                </div>
            </div>
    ...
    <section class="content">
                    ...
                    <div class="card" id="CardHead">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                E-Surat Permintaan Barang PSW Robot (SPB)
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('strout8.update') }}" method="POST">
                            @csrf
                            <div class="CardHead">
                                <div class="card-header">
                                    <h3 class="card-title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3 mb-1">
                                <select style="width: 100%;" id="line_id" class="form-control select2" required>
                                    ...
                                    <option value="PSW ROBOT">PSW ROBOT</option>
                                </select>
                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).ready(function() {
                var getActualUrl = '{{ route('strout8.getActual') }}'; // Menghasilkan URL route
            ...
            function getDoc(){
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{route('strout8.getdoc')}}",
                    success: function(result) {
                        $("#id").val('');
                        $("#doc_no").val("SPB/ASI/WELDING/PSWROBOT/"+year+month+"/"+result.jml);
                        $("#date_plan").val('');
                        $('#line_id').val('');
                        $('#item_id').val('');
                        $("#qty_return").val('');
          ...
          // Script untuk menangani klik tombol detail dan memuat modal
            $(document).on("click", ".btn-details", function () {
                var doc_no = $(this).data('doc_no'); // Ambil doc_no dari tombol yang diklik
                 ...
                 $.ajax({
                    type: 'GET',
                    url: "{{ route('strout8.listdetail3') }}", // Route yang mengarah ke listdetail3
                        data: {
                            doc_no: doc_no
                        },
                        success: function(result) {
                ...
                document.getElementById("saveChecked").addEventListener("click", function() {
                    ...
                    if (checkedItems.length > 0) {
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('strout8.saveChecked') }}",  // Sesuaikan URL
                            data: {
                                items: checkedItems,
            ...
            function delete_draft(){
                    $.ajax({
                        type: 'POST',
                        url: "{{route('strout8.delete_draft')}}",
                        data: {
                            doc_no: doc_no.value,
                            _token: '{{csrf_token()}}'
                            },
            ...
            const Toast = Swal.mixin({
                ...
                container: 'swal2-toast-container'
                    ...
                    window.location.href = "{{ route('strout8.export') }}?start_date=" + startDate + "&end_date=" + endDate;
                    } else {
                    Toast.fire({
                    icon: 'warning',
