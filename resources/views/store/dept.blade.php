...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0" style="font-family: 'Times New Roman', Times, serif">Data Departement</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List Data Departement</h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="title1">Tambah Departement</h4>
                    <h4 class="modal-title" id="title2">Edit Departement</h4>
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" id="name_dept" class="form-control form-control-sm" required>
                        </div>

                        <label class="col-sm-3 col-form-label">Dept Head :</label>
                        <div class="col-sm-9">
                            <input type="text" id="head" class="form-control form-control-sm" required>
                        </div>

                        <label class="col-sm-3 col-form-label">Code-Dept :</label>
                        <div class="col-sm-9">
                            <input type="text" id="code" class="form-control form-control-sm" required>
                        </div>
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.success) {
                        $('#myModal2').modal({ backdrop: 'static', keyboard: false, show: true });
                        $('#id').val(result.id);
                        $('#name_dept').val(result.name_dept);
                        $('#head').val(result.head);
