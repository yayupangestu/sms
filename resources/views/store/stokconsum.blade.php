...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">Stok Items Consumable ASI-1</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card" id="CardHead">
                        <div class="card-header" style="background-color:  rgb(126, 144, 144)">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="{{route("stokconsum.export")}}" class="btn btn-success btn-sm"><i
                        ...
                        <div class="date-filter">
                            <div class="filter-item">
                                <label>Start:</label>
                                <input type="date" id="start_date" class="form-control2">
                            </div>
                            <div class="filter-item">
                                <label>End:</label>
                                <input type="date" id="end_date" class="form-control2">
                            </div>
        ...
        $(document).on("click", ".export-option", function () {
            ...
            if (type === "history") {
                window.location.href =
                    "{{ route('stokconsum.export') }}?start_date=" + startDate + "&end_date=" + endDate;
                return;
            }
            ...
            if (type === "data") {
                window.location.href =
                    "{{ route('consum.export.summary') }}?start_date=" + startDate + "&end_date=" + endDate;
                return;
            }
        });
