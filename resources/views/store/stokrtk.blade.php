...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0">Stok Items RTK ASI-1</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card" id="CardHead">
                        <div class="card-header" style="background-color:  rgb(126, 144, 144)">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="{{route("stokrtk.export")}}" class="btn btn-success btn-sm"><i
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-1">
                            ...
                            <select style="width: 100%;" id="item_id" class="form-control select2" class="text-center"
                                ...
                                @foreach ($master_list_strs as $master_list_str)
                                    <option style="text-align: center" value="{{ $master_list_str->id }}">
                                        {{ $master_list_str->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
