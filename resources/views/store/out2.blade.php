...
.swal2-popup.swal2-toast.colored-toast {
    ...
    color: white; /* Optionally, you can change text color as well */
}
...
.swal2-toast {
    background-color: #f69595 !important; /* Warna kuning */
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="m-0">   E-Surat Permintaan Barang LINE C1 & C2</h1>
      </div>
      <div class="col-sm-6">
      </div>
    </div>
  ...
  <div class="container-fluid">
                   ...
                   <div class="date-filter">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item export-option" data-type="history" href="#">Export History</a></li>
                                <li><a class="dropdown-item export-option" data-type="data" href="#">Export Data (Summary)</a></li>                                                        
                            </ul>
                        </div>
                    </div>
                    <br>
   ...
   <div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('strout2.update') }}" method="POST">
                    @csrf
                    <div class="CardHead">
                        <div class="card-header">
                            <h3 class="card-title">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).ready(function() {
                var getActualUrl = '{{ route('strout2.getActual') }}'; // Menghasilkan URL route
            ...
            function getDoc(){
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{route('strout2.getdoc')}}",
                    success: function(result) {
                        $("#id").val('');
                        $("#doc_no").val("SPB/ASI/STAMPING/LINEC/"+year+month+"/"+result.jml);
                        $("#date_plan").val('');
                        $('#line_id').val('');
                        $('#item_id').val('');
                        $("#qty_return").val('');
                ...
                function showModalWithDetails(data) {
                    ...
                    detailsModal.show();
                        ...
                        function updateSaveButtonStatus() {
                            ...
                            const saveButton = document.getElementById('saveChecked');
                            
                            const allChecked = Array.from(checkboxes).every(checkbox => checkbox.checked);
                            
                            saveButton.disabled = !allChecked;
              ...
              document.getElementById("saveChecked").addEventListener("click", function() {
                ...
                document.querySelectorAll(".item-checkbox:checked").forEach(function(checkbox) {
                    ...
                    if (checkedItems.length > 0) {
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('strout2.saveChecked') }}",  // Sesuaikan URL
                            data: {
                                items: checkedItems,
                    ...
                    success: function(result) {
                        $.each(result.data, function(key, value) {
                            ...
                            html += '<tr class="text-center">'+
                                    ...
                                    '<td><input type="hidden" name="idket['+ idket++ +']" value="'+value.id+'"><input style="width:90" type="text" name="ket['+ keterangan++ +']" value="'+ket+'"></td>'+
                                    '<td>'+createdby+'</td>'+
                                    '<td>'+qty_standing+'</td>'+
                                    '</tr>';
                        })
...
$(document).on("click", ".export-option", function () {
    ...
    if (type === "history") {
        window.location.href =
            "{{ route('strout2.export') }}?start_date=" + startDate + "&end_date=" + endDate;
        return;
    }
    ...
    if (type === "data") {
        window.location.href =
            "{{ route('strout2.export.summary') }}?start_date=" + startDate + "&end_date=" + endDate;
        return;
    }
});
