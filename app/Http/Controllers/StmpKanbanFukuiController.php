...
use App\Models\StmpTagKanbanFukui;
...
class StmpKanbanFukuiController extends Controller
{
    public function index()
    {
       ...
       $data_fg_stampings = PlanningLineB3::whereBetween('created_at', [$startTime, $endTime])
        ...
        return view('stamping.tagkanbanfukui', compact('title','line_stmps','data_part_names','rm_materials','master','data_fg_stampings'));
    }

    public function list()
    {
        $query = DB::table('stmp_tag_kanban_fukuis as a')
    ...
    public function getDropdownData()
    {
        ...
        $data = DB::table('planning_line_b3_s')
            ...
            ->where('mesin', 'FUKUI') // Filter mesin
...
public function store(Request $request)
{
    ...
    public function cetak($id)
    {
        ...
        $master = StmpTagKanbanFukui::findOrFail($id);
