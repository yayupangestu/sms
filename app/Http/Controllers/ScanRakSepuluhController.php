...
class ScanRakSepuluhController extends Controller
{
    public function index(){
        $title = 'Scan Rak 10';
        return view('scanner2.scanrak10', compact('title'));
    }
    ...
    public function storeScanOutNut(Request $request)
{
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://20.20.16.212/relay1/on');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://20.20.16.212/relay1/off');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://20.20.16.212/relay2/off');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://20.20.16.212/relay2/on');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://20.20.16.212/relay3/off');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://20.20.16.212/relay3/on');
