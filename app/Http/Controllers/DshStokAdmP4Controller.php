...
class DshStokAdmP4Controller extends Controller
{
    public function index()
{
    ...
    // Kirim data ke view
    return view('dashboard2.stokadmp4', compact('title', 'totalPcStoreSafe', 'totalPcStoreMin','totalPcStoreOrder','totalPcStoreEmpty'));
}
    ...
    {
        $data = PcStoreDirect::whereIn('customer', ['ADM PLANT 4'])
