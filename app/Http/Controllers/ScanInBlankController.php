...
class ScanInBlankController extends Controller
{
    public function index()
    {
        $title = 'SCAN IN BLANK';
        return view('blank.scanin', compact('title'));
    }
    ...
    public function store2(Request $request)
    {
        ...
        try {
            ...
            $planningLines = PlanningLineB3::where('mesin_category', 2)
                ->where('shift', $shiftNow)
            ...
            foreach ($planningLines as $planningLine) {
                ...
                } elseif ($lineName === 'FUKUI' && $hasSamePartInOtherLine) {
