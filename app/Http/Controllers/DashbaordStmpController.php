...
class DashbaordStmpController extends Controller
{
    public function index()
    {
        ...
        return view('pcstore.dashboardstmp', compact('title', 'planningDataB3','planningDataC1','planningDataC2','planningDataKomatsu','planningDataFukui','planningDataA1','planningDataA2','planningDataB1','planningDataB2','planningData3000'));
    }

    // app/Http/Controllers/Dashbaord2Controller.php
    public function getDashboardDataStmp(Request $request)
    {
        $shift = $request->shift;
