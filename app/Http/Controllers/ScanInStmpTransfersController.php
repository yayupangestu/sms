...
class ScanInStmpTransfersController extends Controller
{
    public function index()
    {
        $title = 'Scan1';
        return view('scanner2.scaninstmpTRANSFERS', compact('title'));
    }
...
//                 // // Tentukan shift sekarang: shift 1 (07:00 - 20:00), shift 2 (20:00 - 07:00)
...
//                 if ($lineName === 'TRASFERS') {
//                     $otherLine = 'TRANSFERS';
//                 } elseif ($lineName === 'TRANSFERS') {
//                     $otherLine = 'TRASFERS';
//                 }
...
//                 if ($lineName === 'TRANSFERS') {
//                     $planningLine->status = 2;
//                     $planningLine->status_proses = 2;
//                 } elseif ($lineName === 'TRANSFERS' && $hasSamePartInOtherLine) {
...
public function store2(Request $request)
{
    ...
    try {
        ...
        // ================= RM KE SLOT MATERIAL (TIDAK DIUBAH) =================
        ...
        // ================= STAMPING IN (DIARAHKAN KE part_no2 TERPILIH) =================
      foreach ($planningLines as $planningLine) {

    // pastikan qty_in_material tidak null
    if (is_null($planningLine->qty_in_material)) {
        $planningLine->qty_in_material = 0;
    }
    ...
    if (is_null($planningLine->stmp_in_qty)) {
        ...
        $planningLine->stmp_in_partNo = $isSprating
            ? $planningLine->part_no
            : $planningLine->part_no;
    ...
    // ================= SLOT 2 =================
        ...
        $planningLine->stmp_in_partNo2 = $isSprating
            ? $planningLine->part_no
            : $planningLine->part_no2;
    ...
    // ================= SLOT 3 =================
        ...
        $planningLine->stmp_in_partNo3 = $isSprating
            ? $planningLine->part_no
            : $planningLine->part_no3;
    ...
    // ================= SLOT 4 =================
        ...
        $planningLine->stmp_in_partNo4 = $isSprating
            ? $planningLine->part_no
            : $planningLine->part_no4;
    ...
    // ================= SLOT 5 =================
        ...
        $planningLine->stmp_in_partNo5 = $isSprating
            ? $planningLine->part_no
            : $planningLine->part_no5;
