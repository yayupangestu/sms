...
class DshStokD26TmminController extends Controller
{
    public function index()
{
    ...
    // Kirim data ke view
    return view('dashboard2.stokd26tm', compact('title', 'totalPcStoreSafe', 'totalPcStoreMin','totalPcStoreOrder','totalPcStoreEmpty'));
}
    ...
    {
        $data = PcStoreDirect::whereIn('customer', ['TMMIN'])
