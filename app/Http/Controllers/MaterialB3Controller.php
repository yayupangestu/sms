...
class MaterialB3Controller extends Controller
{
    public function index()
    {
        ...
        $tabel_b3_s = DB::table('tabel_b3_s as a')
                ...
                ->get();
        return view('rmmaterial.materialb3', compact('title', 'line_stmps', 'data_part_names', 'rm_materials', 'tabel_b3_s'));
    }
    
    public function list(Request $request)
    {
        $query = DB::table('planning_line_b3_s as a')
                ->select('a.id', 'e.part_name', 'a.qty_plan', 'd.name_material as spek', 'e.job_no', 'f.name as model', 'a.time_start', 'a.time_end')
