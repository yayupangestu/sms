...
class ScanRakTujuhBelasController extends Controller
{
    public function index(){
        $title = 'Scan Rak 17';
        return view('scanner2.scanrak17', compact('title'));
    }
    ...
    public function storeScanOutNut(Request $request)
{
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://192.168.10.196/relay1/on');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://192.168.10.196/relay1/off');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://192.168.10.196/relay2/off');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://192.168.10.196/relay2/on');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://192.168.10.196/relay3/off');
    ...
    {
        try {
            $response = Http::withoutVerifying()->get('http://192.168.10.196/relay3/on');
