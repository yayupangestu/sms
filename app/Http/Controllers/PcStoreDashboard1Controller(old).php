...
class PcStoreDashboard1Controller extends Controller
{
    public function index(){
        ...
        // Ambil data dari tabel 'pc_store_directs'
        ...
        // Return the view with data yang sudah ada di database
        return view('pcstore.dashboard1', compact('title', 'pc_store_directs'));
    }
...
{
    $data = PcStoreDirect::where('model', 'D26 ADM')->get(); // hanya D26 ADM
...
{
    $data = PcStoreDirect::where('model', 'D26 TMMIN')->get(); // hanya D26 ADM
...
{
    // ambil part_no dan qty_order (atau field yang mau ditampilkan)
    $data = PcStoreDirect::select('job_no', 'qty_act','monthly_volume')
