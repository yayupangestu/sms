...
class ItemsOut2ExportStr2 implements FromCollection,WithTitle,ShouldAutoSize,WithHeadings,WithEvents,WithMapping
{
    ...
    public function title(): string{
		return 'Data Total Item-Out LINE C ASI-2';
    ...
    public function map($qry): array
{
    ...
    {
        return [
            ["Data Total Item-Out LINE C ASI-2"],
            [""],
            [""],
            ["No",
            "Doc No",
