...
class ItemsInExportStr2 implements FromCollection,WithTitle,ShouldAutoSize,WithHeadings,WithEvents,WithMapping
{
    ...
    public function title(): string{
		return 'Data Total Item-IN Store Room - 2';
	}

    public function collection()
    {
        set_time_limit(0);
        $qry = DB::table('str2_ins as a')
    ...
    {
        return [
            ["Data Total Item-Out Store Room ASI-2"],
            [""],
            ["No",
            "Suplai",
            "Item Name", 
