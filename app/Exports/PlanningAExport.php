...
class PlanningAExport implements FromCollection, WithHeadings, ShouldAutoSize, WithTitle, WithEvents
{
    protected $startDate;
    protected $endDate;
    protected $mesin;
    ...
    public function collection()
    {
        ...
        if ($this->mesin === 'All') {
            $query->whereIn('mesin', ['LINE A1', 'LINE A2']);
        } else {
