...
class PlanningB12Export implements FromCollection, WithHeadings, ShouldAutoSize, WithTitle, WithEvents
{
    protected $startDate;
    protected $endDate;
    protected $mesin;
    ...
    public function collection()
    {
        ...
        if ($this->mesin === 'All') {
            $query->whereIn('mesin', ['LINE B1', 'LINE B2']);
        } else {
