...
class StrWeldingExport implements FromCollection, WithTitle, ShouldAutoSize, WithHeadings, WithEvents, WithMapping
{
    protected $startDate;
    protected $endDate;
    ...
    public function collection()
    {
        ...
        $query1 = DB::table('str_out8s as a')
        ...
        $query2 = DB::table('str_out9s as a')
            ->select('a.qty_out', 'b.name as satuan', 'a.date_plan', 'a.line_id', 'c.name as item_id', 'a.id as id', 'a.doc_no', 'a.qty_request', 'a.qty_return', 'a.price_item', 'a.keterangan')
            ->leftJoin('str_uoms as b', 'b.id', '=', 'a.satuan')
            ->leftJoin('master_list_strs as c', 'c.id', '=', 'a.item_id')
            ->whereBetween('a.date_plan', [$this->startDate, $this->endDate]);
        ...
        // Query untuk tabel str_out3s
        $query3 = DB::table('str_out10s as a')
            ->select('a.qty_out', 'b.name as satuan', 'a.date_plan', 'a.line_id', 'c.name as item_id', 'a.id as id', 'a.doc_no', 'a.qty_request', 'a.qty_return', 'a.price_item', 'a.keterangan')
            ->leftJoin('str_uoms as b', 'b.id', '=', 'a.satuan')
            ->leftJoin('master_list_strs as c', 'c.id', '=', 'a.item_id')
            ->whereBetween('a.date_plan', [$this->startDate, $this->endDate]);
        ...
        // Query untuk tabel str_out3s
        $query4 = DB::table('str_out11s as a')
            ->select('a.qty_out', 'b.name as satuan', 'a.date_plan', 'a.line_id', 'c.name as item_id', 'a.id as id', 'a.doc_no', 'a.qty_request', 'a.qty_return', 'a.price_item', 'a.keterangan')
            ->leftJoin('str_uoms as b', 'b.id', '=', 'a.satuan')
            ->leftJoin('master_list_strs as c', 'c.id', '=', 'a.item_id')
            ->whereBetween('a.date_plan', [$this->startDate, $this->endDate]);
        ...
        // Query untuk tabel str_out3s
        $query5 = DB::table('str_out12s as a')
            ->select('a.qty_out', 'b.name as satuan', 'a.date_plan', 'a.line_id', 'c.name as item_id', 'a.id as id', 'a.doc_no', 'a.qty_request', 'a.qty_return', 'a.price_item', 'a.keterangan')
            ->leftJoin('str_uoms as b', 'b.id', '=', 'a.satuan')
            ->leftJoin('master_list_strs as c', 'c.id', '=', 'a.item_id')
            ->whereBetween('a.date_plan', [$this->startDate, $this->endDate]);
        ...
        // Query untuk tabel str_out3s
        $query6 = DB::table('str_out13s as a')
            ->select('a.qty_out', 'b.name as satuan', 'a.date_plan', 'a.line_id', 'c.name as item_id', 'a.id as id', 'a.doc_no', 'a.qty_request', 'a.qty_return', 'a.price_item', 'a.keterangan')
            ->leftJoin('str_uoms as b', 'b.id', '=', 'a.satuan')
            ->leftJoin('master_list_strs as c', 'c.id', '=', 'a.item_id')
            ->whereBetween('a.date_plan', [$this->startDate, $this->endDate]);
        ...
        // Query untuk tabel str_out3s
        $query7 = DB::table('str_out14s as a')
            ->select('a.qty_out', 'b.name as satuan', 'a.date_plan', 'a.line_id', 'c.name as item_id', 'a.id as id', 'a.doc_no', 'a.qty_request', 'a.qty_return', 'a.price_item', 'a.keterangan')
            ->leftJoin('str_uoms as b', 'b.id', '=', 'a.satuan')
            ->leftJoin('master_list_strs as c', 'c.id', '=', 'a.item_id')
            ->whereBetween('a.date_plan', [$this->startDate, $this->endDate]);
        ...
        $results = $query1->union($query2)->union($query3)->union($query4)->union($query5)->union($query6)->union($query7)->get();
    ...
    {
        return [
            ["Data Total Item-Out Line Stamping  "],
            [""],
