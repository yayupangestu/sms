...
class AtkExport implements FromCollection,WithTitle,ShouldAutoSize,WithHeadings,WithEvents,WithMapping
{
    private $rowNumber = 1;

    public function title(): string{
		return 'Data Stok ATK';
	}

    public function collection()
    {
        set_time_limit(0);
        $qry = DB::table('str_stok_atks as a')
