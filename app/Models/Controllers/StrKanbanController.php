...
class StrKanbanController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.kanban', compact('title', 'str_out2s', 'users', 'str_uoms','str_out3s','str_out4s','str_out5s','str_out6s','str_out7s','str_out8s', 'str_out9s','str_out11s','str_out10s','str_out12s','str_out13s','str_out14s','str_out15s','str_out16s','str_out17s','str_out18s','str_out19s','str_out20s'));
    }
