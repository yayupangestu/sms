...
class CekStokController extends Controller
{
    public function checkStock()
    {
        ...
        $str_stok_atks = DB::table('str_barangs as a')
                    ->select('a.name')
    ...
    public function checkStock2()
    {
        ...
        $str_stok_rtks = DB::table('str_barangs as a')
                    ->select('a.name')
    ...
    {
        $str_stok_consums = DB::table('str_barangs as a')
                    ->select('a.name')
    ...
    {
        $str_stok_gases = DB::table('str_barangs as a')
                    ->select('a.name')
    ...
    {
        $str_stok_tis = DB::table('str_barangs as a')
                    ->select('a.name')
    ...
    {
        $str_stok_cuptips = DB::table('str_barangs as a')
                    ->select('a.name')
    ...
    {
        $str2_stok_atks = DB::table('str_barangs as a')
                    ->select('a.name')
    ...
    {
        $str2_stok_rtks = DB::table('str_barangs as a')
                    ->select('a.name')
    ...
    {
        $str2_stok_consums = DB::table('str_barangs as a')
                            ->select('a.name')
    ...
    {
        $str2_stok_gases = DB::table('str_barangs as a')
                          ->select('a.name')
    ...
    {
        $str2_stok_tis = DB::table('str_barangs as a')
                          ->select('a.name')
