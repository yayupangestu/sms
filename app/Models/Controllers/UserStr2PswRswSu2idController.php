...
class UserStr2PswRswSu2idController extends Controller
{
    public function index()
    {
        $title = 'OUT PSW & RSW SU2ID';
        ...
        return view('userspbstr2.linepswrswsu2id', compact('title', 'departements', 'str_uoms', 'str_barangs', 'users'));
    }
}
